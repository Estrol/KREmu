...
namespace Estrol.KREmu.Servers.Parser {
    ...
    public static class OJNDecoder {
        ...
        public static OJN Decode(string filename, Encoding encoding = default) {
        ...
        public static OJN Decode(Stream stream, Encoding encoding = default, bool keepOpen = false) {
